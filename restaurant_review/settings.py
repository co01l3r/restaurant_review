...
SECRET_KEY = 'django-insecure-g(mmr!v8d%as(sqoq#x6-z#7s@p#&^#dtq6!+*3b=fs((naxnm'
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "reviews.api.serializers.MyTokenObtainPairSerializer",
...
AUTH_USER_MODEL = 'reviews.Customer'
